...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'pt/yolov5m6.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=ROOT / 'backmodel.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'back.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='exp_back', help='save to project/name')
